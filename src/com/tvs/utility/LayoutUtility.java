...
public enum Layout {
  ...
  public void applyRelativeLayoutParams(View relativelayout) {
	  applyRelativeLayoutParamsTo(this, relativelayout);
 }
...
private static void applyRelativeLayoutParamsTo(Layout layout, View view) {
